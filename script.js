document.getElementById('noButton').addEventListener('click', function() {
    ...
    const noButtonTexts = ["No", "Are you sure Nikki?", "Really sure Nikki?", "Are you positive Nikki???", "Honey please", "Just think about it bebe", "If you say no, I'll be muy sad", "I'll be muy muy sad", "I'll be muy muy muy sad", "I'll be uber sad", "Ok fine, I'll stop asking...", "Just kidding, PLEASE SAY YES", "Don't be ghey woman click yes naur", "You're breaking my heart ;("];
